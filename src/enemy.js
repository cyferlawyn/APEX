...
const BASE_STATS = {
  [EnemyType.DRONE]:    { hp: 500,   speed: 156, radius: 11, color: '#00e5ff', shape: 'circle',   reward: 24,  damage: 15  },
  [EnemyType.SWARM]:    { hp: 167,   speed: 120, radius: 8,  color: '#69ff47', shape: 'circle',   reward: 8,   damage: 5   },
  [EnemyType.BRUTE]:    { hp: 2500,  speed: 78,  radius: 16, color: '#ff9100', shape: 'square',   reward: 100, damage: 50  },
  [EnemyType.ELITE]:    { hp: 1250,  speed: 129, radius: 11, color: '#ea00ff', shape: 'triangle', reward: 60,  damage: 30  },
  [EnemyType.BOSS]:     { hp: 41667, speed: 80,  radius: 28, color: '#ff1744', shape: 'star8',    reward: 600, damage: 250 },
  // New types
  [EnemyType.DASHER]:   { hp: 375,   speed: 164, radius: 9,  color: '#00e676', shape: 'circle',   reward: 36,  damage: 20  },
  [EnemyType.BOMBER]:   { hp: 1000,  speed: 112, radius: 13, color: '#ff6d00', shape: 'circle',   reward: 70,  damage: 60  },
  [EnemyType.SPAWNER]:  { hp: 4167,  speed: 38,  radius: 18, color: '#ffd600', shape: 'square',   reward: 160, damage: 20  },
  [EnemyType.PHANTOM]:  { hp: 1083,  speed: 138, radius: 11, color: '#b388ff', shape: 'triangle', reward: 56,  damage: 25  },
  [EnemyType.COLOSSUS]: { hp: 10000, speed: 48,  radius: 24, color: '#ff4081', shape: 'hexagon',  reward: 400, damage: 75  },
};
